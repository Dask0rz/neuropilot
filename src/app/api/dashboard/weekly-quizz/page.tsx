...
export default function WeeklyQuizPage() {
    ...
    <div className="min-h-screen p-6 max-w-2xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-white/60">
          {result.score >= 8 ? '🔥 Excellent !' : result.score >= 5 ? '👍 Bien joué !' : '💪 Continue !'}
        </p>
      </div>
      ...
      <button
        ...
        className="mt-8 w-full py-3 bg-cyan-500 text-black font-bold rounded-xl"
      >
        Retour au dashboard
      </button>
    </div>
  ...
  if (submitted && !result) return (
    <div className="flex flex-col items-center justify-center min-h-screen gap-4">
      ...
      <p className="text-white/40">Reviens lundi prochain pour le prochain quiz.</p>
  ...
  return (
    <div className="min-h-screen p-6 max-w-2xl mx-auto">
      ...
      <div className="mb-6">
        {question.newsSource && (
          <p className="text-xs text-cyan-400/60 mb-2">📰 {question.newsSource}</p>
        )}
      ...
      <div className="flex gap-3">
        ...
        {currentQ < quiz.questions.length - 1 ? (
          <button
            ...
            className="flex-1 py-3 bg-cyan-500 text-black font-bold rounded-xl disabled:opacity-40"
          >
            Suivant →
          </button>
        ) : (
          <button
            ...
            className="flex-1 py-3 bg-green-500 text-black font-bold rounded-xl disabled:opacity-40"
          >
